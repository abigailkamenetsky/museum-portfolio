    ...
    exhibit: {
      ...
      pieces: [
        ...
        { title: 'SporeKeeper', artwork: 'Edvard Munch - The Scream', art: 'scream.jpg', artAspect: 1.264,
          blurb: [
            "A privacy-first Chrome extension that notices when you have started working and asks whether you clocked in, then helps you file the tabs you piled up while doing it. Built in TypeScript with 452 tests, zero runtime dependencies, and zero network requests. Submitted to the Chrome Web Store and awaiting approval, where it will be free. Playable in the browser now, no install.",
            ...
            "The linked demo is not the extension. It is the extension's real interface and real compiled logic running in a page against a simulated browser, so it can be used before the Store approves it. Every decision in it is the real one. The service worker, Chrome storage and real tabs are stand-ins, and the demo page says so itself rather than leaving you to find out.",
          ],
  ...
  },
  {
    ...
    exhibit: {
      ...
      pieces: [
        ...
        { title: 'Crocheting', artwork: 'Berthe Morisot - Young Woman Knitting', art: 'knitting.jpg', artAspect: 0.835, blurb: "I crochet in my free time, mostly little gifts and cozy things. It's so relaxing.", photos: [], items: [], images: [], links: [] },
