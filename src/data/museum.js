    ...
    exhibit: {
      ...
      pieces: [
        ...
        { title: 'Undisclosed Startup App', artwork: 'Salvador Dalí - The Elephants', art: 'elephants.jpg', artAspect: 0.835,
          ...
          skills: ['Product ideation', 'Rapid prototyping', 'App development', 'Working through ambiguity'],
          items: [], images: [], links: [] },
        { title: 'Handshake AI Agent', artwork: 'René Magritte - Golconda', art: 'golconda.jpg', artAspect: 0.815,
          ...
          skills: ['AI agent development', 'LLM tooling', 'Workflow automation', 'API integration'],
          items: [], images: [], links: [] },
        { title: 'Color Block Jam - Ad Blocker', artwork: 'Edvard Munch - The Scream', art: 'scream.jpg', artAspect: 1.264, blurb: 'Ad-blocking / game project. What it does and how it works.',
          skills: ['Browser extension development', 'JavaScript', 'Game logic', 'Debugging'],
          items: [], images: [], links: [] },
        { title: 'Parking & Transportation App', artwork: 'J.M.W. Turner - Rain, Steam and Speed', art: 'rainsteamspeed.jpg', artAspect: 0.743,
          ...
          skills: ['Product development', 'User research', 'Pitching', 'Project management'],
          items: [], images: [], links: [] },
      ],
    },
  },
  {
    ...
    exhibit: {
      ...
      pieces: [
        ...
        { title: 'Gigamon - Product Management', artwork: 'Pieter Bruegel the Elder - The Tower of Babel', art: 'babel.jpg', artAspect: 0.732, blurb: 'Product management internship. Role, dates, impact.',
          skills: ['Product strategy', 'Roadmapping', 'Stakeholder communication', 'User research', 'Prioritization'],
          items: [], images: [], links: [] },
        { title: 'SDIG - Web Development', artwork: 'Claude Monet - The Bridge at Argenteuil', art: 'argenteuil.jpg', artAspect: 0.761, blurb: 'Web development. Role, dates, impact.',
          skills: ['Web development', 'Front-end engineering', 'Responsive design', 'Debugging', 'Version control'],
          items: [], images: [], links: [] },
      ],
    },
  },
    ...
    exhibit: {
      ...
      pieces: [
        { title: 'CMU - Rectangle Packing (NP-hard)', artwork: 'M.C. Escher - Relativity', art: 'relativity.jpg', artAspect: 0.958,
          ...
          items: [], images: [], links: [] },
        { title: 'UCSB - LLM Hallucinations', artwork: 'Salvador Dalí - The Temptation of Saint Anthony', art: 'stanthony.jpg', artAspect: 0.783, blurb: 'Research on LLM hallucinations.',
        ...
        { title: 'Booth - Center for Applied AI', artwork: 'Joseph Wright of Derby - An Experiment on a Bird in the Air Pump', art: 'airpump.jpg', artAspect: 0.749, blurb: 'Applied AI research at Chicago Booth. Topic, methods, findings.',
          skills: ['Applied AI research', 'Data analysis', 'Literature review', 'Research methods'],
          items: [], images: [], links: [] },
      ],
    },
  },
    ...
    exhibit: {
      ...
      pieces: [
        { title: 'Succeeding in the Entrepreneurial Workplace', artwork: 'Hans Holbein the Younger - The Ambassadors', art: 'ambassadors.jpg', artAspect: 0.985,
          ...
          skills: ['Startup readiness', 'Professional communication', 'Networking', 'AI productivity tools'],
          items: [], images: [], links: [] },
        ...
        { title: 'Venture Capital Immersion Week', artwork: 'Caravaggio - The Calling of Saint Matthew', art: 'callingmatthew.jpg', artAspect: 0.934,
          ...
          skills: ['Investment thesis development', 'Market sizing', 'Financial modeling', 'Deal sourcing', 'Founder pitch evaluation'],
          items: [], images: [], links: [] },
    ...
    exhibit: {
      ...
      pieces: [
        { title: 'Journalism / Newspaper Leadership', artwork: 'Diego Velázquez - Las Meninas', art: 'meninas.jpg', artAspect: 1.151,
          ...
          items: [], images: [], links: [] },
        { title: 'Pinewood Envoys', artwork: 'Jan van Eyck - The Arnolfini Portrait', art: 'arnolfini.jpg', artAspect: 1.368, blurb: 'Ambassador / envoy program.',
