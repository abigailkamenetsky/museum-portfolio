    ...
    exhibit: {
      ...
      pieces: [
        ...
        { title: 'Tech Showcase Parking App', artwork: 'Salvador Dalí - The Elephants', art: 'elephants.jpg', artAspect: 0.835,
          ...
          why: "I picked The Elephants because the project is still forming and much of it remains uncertain. Dalí's surreal architecture and impossible structures reflect the process of building something that does not yet fully exist.",          items: [], images: [], links: [] },
        { title: 'Handshake AI Agent', artwork: 'René Magritte - Golconda', art: 'golconda.jpg', artAspect: 0.815,
          ...
          why: "I picked Golconda because it depicts countless identical figures suspended in space. It reminds me of large-scale networks, automation, and intelligent systems operating simultaneously across many users.",          items: [], images: [], links: [] },
        ...
        { title: 'Lyft/Via UChicago App for Fall', artwork: 'J.M.W. Turner - Rain, Steam and Speed', art: 'rainsteamspeed.jpg', artAspect: 0.743,
          ...
          why: "I picked Rain, Steam and Speed by J.M.W. Turner because it captures a train surging through the landscape, the force and thrill of modern movement. It connects naturally to a project focused on helping people move through cities more efficiently.",          items: [], images: [], links: [] },
      ],
    },
  },
  {
    ...
    exhibit: {
      ...
      pieces: [
        ...
        { title: 'Gigamon - Product Management', artwork: 'Rembrandt - The Night Watch', art: 'nightwatch.jpg', artAspect: 0.838, blurb: 'Product management internship. Role, dates, impact.',          items: [], images: [], links: [] },
